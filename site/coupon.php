<?php session_start();$config = parse_ini_file("site.ini");?>
<!DOCTYPE html>
<html lang="en">
...
<body>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <a href="index.html"><img src="img/logomd.png" alt="" class="img-fluid"></a>
      </div>
      ...
      <nav id="navbar" class="navbar">
        <ul>
            ...
            <!-- <li class="small-logo"><a href="#header"><img class="nlogo" width="100px" src="img/logomd.png" alt=""></a></li> -->
            <!-- <li><a href="#client">Clients</a></li> -->
            <li><a href="#">Coupons</a></li>
            <li><a href="contact.php">Contact</a></li>
          </li>
          <?php $topage = (isset($_SESSION["userid"]) && $_SESSION["userid"] != "")?"logout":"login";
              $onbuy = $topage == "login"? "login.php":"pay/checkout.php";
          ?>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-2">
            <div class="box" data-aos="zoom-in" data-aos-delay="100">
              <h3>Coupon 1</h3>
              <h4><sup>&#8377;</sup>100<span> / code</span></h4>
              <ul>
              ...
              <div class="btn-wrap">
                <a href="<?= $onbuy?>?code=1" class="btn-buy">Buy Now</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mt-4 mt-md-0">
            <div class="box" data-aos="zoom-in">
              <h3>Coupon 2</h3>
              <h4><sup>&#8377;</sup>200<span> / code</span></h4>
              <ul>
                <li class="na">Customer Support</li>
                <li>Low budjet</li>
                <!-- <li>Nec feugiat nisl</li>
              ...
              <div class="btn-wrap">
                <a href="<?= $onbuy?>?code=2" class="btn-buy">Buy Now</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mt-4 mt-lg-0">
            <div class="box" data-aos="zoom-in" data-aos-delay="100">
              ...
              <div class="btn-wrap">
                <a href="<?= $onbuy?>?code=3" class="btn-buy">Buy Now</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mt-4 mt-lg-0">
            <div class="box" data-aos="zoom-in" data-aos-delay="100">
              <h3>Coupon 4</h3>
              <h4><sup>&#8377;</sup>300<span> / code</span></h4>
              <ul>
                <li class="">Customer Support</li>
                <li>Regular </li>
                <!-- <li>Nulla at volutpat dola</li>
              ...
              <div class="btn-wrap">
                <a href="<?= $onbuy?>?code=4" class="btn-buy">Buy Now</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mt-4 mt-lg-0">
            ...
            <span class="recommended-badge">Recommended</span>
              <h3>CK Entertainment</h3>
              <h4><sup>&#8377;</sup>400<span> / code</span></h4>
              <ul>
                <li class="">Customer Support</li>
                <li>50% Less in Signup</li>
                <!-- <li>Nulla at volutpat dola</li>
                <li>Pharetra massa</li>
                <li>Massa ultricies mi</li> -->
              </ul>
              <div class="btn-wrap">
                <a href="<?= $onbuy?>?code=5" class="btn-buy">Buy Now</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mt-4 mt-lg-0">
            <div class="box" data-aos="zoom-in" data-aos-delay="100">
              <h3>CK University</h3>
              <h4><sup>&#8377;</sup>500<span> / code</span></h4>
              <ul>
                <li class="">Customer Support</li>
                <li>50% off in Application </li>
                <!-- <li>Nulla at volutpat dola</li>
                <li>Pharetra massa</li>
                <li>Massa ultricies mi</li> -->
              </ul>
              <div class="btn-wrap">
                <a href="<?= $onbuy?>?code=6" class="btn-buy">Buy Now</a>
              </div>
            </div>
          </div>
  ...
  <footer id="footer">
    ...
    <div class="container footer-bottom clearfix">
      <div class="copyright">
        &copy; Copyright <strong><span><?= $config["copyright"]?></span></strong>. All Rights Reserved
      </div>
      <div class="credits">
        ...
        Designed by <a href="<?= $config["ln_madeby"]?>"><?=$config["madeby"]?></a><br>
