<?php $config = parse_ini_file("site.ini");?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
...
<section class="main-section contact" id="contact">
        ...
        <div class="col-lg-6 col-sm-7 wow fadeInLeft">
                <h2>New User</h2>
                <p class="padding-b">Want to join? You can create your account by filling this form, it is <strong>free</strong> and always will be.</p>
                <h2>Have a account?</h2>
                <p class="padding-b">You can access many coupons by logging in and also have access to many presonal resources like promoting business.To sign-in to your account <a href="login.php">click here</a></p>	<br><br>
        	...
        	<div class="col-lg-6 col-sm-5 wow fadeInUp delay-05s">
            	<div class="form">
                    ...
                    <form action="" method="post" role="form" class="contactForm">
                        ...
                        <div class="form-group">
                            <input type="number" class="form-control input-text" name="mobile" id="mobile" placeholder="Enter Phone no" data-rule="minlen:4" data-msg="Please enter at least 10 chars of password" />
                            <div class="validation"></div>
                        </div>
                        <div class="form-group">
                            <input type="password" class="form-control input-password" name="password" id="password" placeholder="Password" data-rule="minlen:4" data-msg="Please enter at least 8 chars of password" />
                            <div class="validation"></div>
                        </div>
                        <div class="form-group">
                            <input type="password" class="form-control input-password" name="cpassword" id="cpassword" placeholder="Confirm Password" data-rule="minlen:4" data-msg="Please enter at least 8 chars of password" />
                            <div class="validation"></div>
                        </div>
                        <!-- <div class="form-group">
                       ...
                       <?php include_once "assets/php/action_page.php"; ?>
                        <div class="text-center"><button type="submit" name="btnSignup" class="input-btn">Register</button></div>
                    </form>
                </div>	
            </div>
...
<footer class="footer">
    <div class="container">
        ...
        <div class="credits">
            ...
            -->
            <a href="<?= $config['ln_madeby']?>">Made by</a> by <a href="<?= $config['ln_madeby']?>"><?= $config['madeby']?></a>
            <br>
