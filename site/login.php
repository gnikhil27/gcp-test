        	...
        	<div class="col-lg-6 col-sm-5 wow fadeInUp delay-05s">
            	<div class="form">
                    ...
                    <form action="" method="post" role="form" class="contactForm">
                        ...
                        <div class="form-group">
                            <input type="password" class="form-control input-text" name="password" id="password" placeholder="Password" data-rule="minlen:4" data-msg="Please enter at least 8 chars of password" required/>
                            <div class="validation"></div>
                        </div>
                       ...
                       <?php include_once "assets/php/action_page.php"; ?>
                        <div class="text-center"><button type="submit" name="btnLogin" id="btnLogin" class="input-btn">Sign In</button></div>
                    </form>
                </div>	
            </div>
            <div class="col-lg-6 col-sm-7 wow fadeInLeft">
                <h2>Login</h2>
                <p class="padding-b">You can access many coupons by logging in and also have access to many presonal resources like promoting business</p>	<br><br>
                <h2>don't have a account?</h2>
                <p class="padding-b">You can create on, it is <strong>free</strong> and always will be. To create account <a href="register.php">click here</a>.</p>
